...
extension NibInitializable where Self: UIView {
    ...
    static func instantiate() -> Self {
        guard let view = nibBundle?.loadNibNamed(nibName, owner: self, options: nil)?.first as? Self else {
...
extension ReusableView where Self: UICollectionViewCell & NibInitializable {
    public static func register(in collectionView: UICollectionView, with identifier: String = Self.reuseIdentifier) {
